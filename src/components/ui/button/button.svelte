  ...
  export const buttonVariants = tv({
    ...
    variants: {
      variant: {
        ...
        destructive: 'bg-destructive text-white hover:bg-(--danger-strong) focus-visible:ring-destructive/20 focus-visible:border-destructive/40 dark:focus-visible:ring-destructive/40',
